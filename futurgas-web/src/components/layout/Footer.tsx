            ...
            <div>
              ...
              <address className="not-italic space-y-3">
                ...
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-xs text-gray-500">(Técnico jefe)</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-5 w-5 text-blue-400 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <a href="tel:+5491163046138" className="text-gray-300 hover:text-white transition-colors">+54 9 11 6304-6138</a>
                  <span className="ml-2 text-xs text-gray-500">(Contabilidad / Presupuestos)</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-5 w-5 text-blue-400 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
